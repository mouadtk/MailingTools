...
To build the final jar and optimize the warmapp application for production, run:
...
Then navigate to [http://localhost:3310](http://localhost:3310) in your browser.
